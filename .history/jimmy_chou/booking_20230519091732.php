...
$getTransportById = $transport->getTransportById($transport_id);
...
if(isset($_POST['first-location']) && isset($_POST['last-location']) && isset($_POST['start_date']) && isset($_POST['end_date']) && isset($_POST['pax'])){
                            ...
                            <form autocomplete="off" action="" class="request-form ftco-animate">
                                ...
                                <div class="row justify-content-around align-items-center">
                                        ...
                                        <div class="form-group">
                                            <div class="g-location">
                                                ...
                                                <input class="form-control" list="GFGOptions" id="GFGDataList"
                                                    name="first-location" placeholder="Chọn điểm đi" value="<?=$f_location?>">
                                            </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="form-group">
                                            <div class="g-location">
                                                ...
                                                <input class="form-control" list="option_drop" id="GFGDataList"
                                                    name="last-location" placeholder="Chọn điểm đến" value="<?=$l_location?>">
                                            </div>
                                    ...
                                    <div class="col-lg-2 col-md-4 col-12">
                                        <div class="form-group">
                                            <input id="start_date" class="form-control" type="date" name="start_date" placeholder="dd/mm/yyyy" value="<?=$start_date?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-12">
                                        <?php  if($trip_type == 0){ ?>
                                            <div class="form-group" id="round-way">
                                                <input id="end_date" class="form-control" name="end_date" placeholder="dd/mm/yyyy" value="<?=$end_date?>">
                                            </div>
                                            <?php } ?>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-12">
